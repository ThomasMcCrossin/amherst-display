...
def main() -> int:
    ...
    parser.add_argument("--game-intro-cards", dest="game_intro_cards", action="store_true", help="Insert the series-open card and between-game recap cards")
    parser.add_argument("--no-game-intro-cards", dest="game_intro_cards", action="store_false", help="Disable inserted series-open / between-game cards")
